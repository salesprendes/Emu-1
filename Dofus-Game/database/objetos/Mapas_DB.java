	...
	public void get_Cargar_Todos_Mapas()
	{
		try
		{
			...
			while(query.get_Rs().next())
			{
				...
				new Mapa(query.get_Rs().getShort(1), query.get_Rs().getString(2), query.get_Rs().getByte(3), query.get_Rs().getByte(4), query.get_Rs().getString(5), query.get_Rs().getString(6), query.get_Rs().getString(7), query.get_Rs().getShort(8), query.get_Rs().getShort(9), query.get_Rs().getShort(10), query.get_Rs().getShort(11));
			}
			cerrar(query);
		}
		catch (final Exception e)
