...
final public class TipoStats
{
	...
	public static final int RETIRAR_VITALIDAD = 153;
	public static final int RETIRAR_INTELIGENCIA = 155;
	public static final int RETIRAR_SABIDURIA = 156;
	...
	public static final int RETIRAR_PORC_PDV_TEMPORAL = 424;
	public static final int AGREGA_STAT_SABIDURIA = 606;
	public static final int AGREGA_STAT_VITALIDAD = 610;
	public static final int AGREGA_STAT_INTELIGENCIA = 611;
