...
public class Personajes implements Entidades
{
	...
	{
		boolean mapa_diferente = _celda == null || posicion.get_Celda() == null ? true : (_celda.get_Mapa() != posicion.get_Celda().get_Mapa());

		if (posicion.get_Celda() != null) 
		{
			posicion.get_Celda().get_Eliminar_Entidad(this, mapa_diferente || !get_Esta_Conectado());
		}
		if (_celda != null) 
		{
			posicion.set_Celda(_celda);
			posicion.get_Celda().get_Agregar_Entidad(this, mapa_diferente && get_Esta_Conectado());
		}
	}
	...
	public final void get_Limpiar_Cache_Gm_Objetos()
	{
		cache_gm_objetos = "";
	}
	
	public final void get_Limpiar_Cache_As()
	{
		cache_as = "";
	}
